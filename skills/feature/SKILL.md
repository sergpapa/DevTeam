...
Launch the **architect** agent with the requirements and repo state. Present its design to the user if it involves choices they'd care about; record accepted decisions with `/adr`.
